...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"@fortawesome/fontawesome-free/css/all.css":"../node_modules/@fortawesome/fontawesome-free/css/all.css","normalize.css":"../node_modules/normalize.css/normalize.css","./images/overlay.png":[["overlay.b2a30f3f.png","sass/images/overlay.png"],"sass/images/overlay.png"],"./images/cat1.jpg":[["cat1.a18b8267.jpg","sass/images/cat1.jpg"],"sass/images/cat1.jpg"],"./images/cat2.jpg":[["cat2.89a965ca.jpg","sass/images/cat2.jpg"],"sass/images/cat2.jpg"],"./images/cat3.jpg":[["cat3.6ff286f4.jpg","sass/images/cat3.jpg"],"sass/images/cat3.jpg"],"./images/cat4.jpg":[["cat4.ec2ac807.jpg","sass/images/cat4.jpg"],"sass/images/cat4.jpg"],"./images/cat5.jpg":[["cat5.77e2cbd7.jpg","sass/images/cat5.jpg"],"sass/images/cat5.jpg"],"_css_loader":"../../../.nvm/versions/node/v11.10.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../../.nvm/versions/node/v11.10.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../.nvm/versions/node/v11.10.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/test.js":[function(require,module,exports) {
'use strict';
...
var shoppingCart = []; // if (window.sessionStorage && window.localStorage) {
...
(0, _jquery.default)('.buy-now').each(function (index, element) {
  (0, _jquery.default)(element).on('click', function (e) {
    (0, _jquery.default)(e.target).parents('.product').find('.product-name').fadeOut('slow', 'linear');
    (0, _jquery.default)(e.target).parents('.product').find('.icon').fadeOut(600, 'linear');
    (0, _jquery.default)(e.target).parents('.product').find('.buy-now').fadeOut('fast');
    (0, _jquery.default)(e.target).parents('.product').find(' .product-detail').css('display', 'block');
    (0, _jquery.default)(e.target).parents('.product-menu').css('top', '40%');
    (0, _jquery.default)(e.target).parents('.product').find('img').fadeTo('slow', 0.5);
  });
...
require("./test");
},{"../sass/main.scss":"sass/main.scss","./test":"js/test.js"}],"../../../.nvm/versions/node/v11.10.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
